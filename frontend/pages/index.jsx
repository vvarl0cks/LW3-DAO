  ...
  return (
    <div>
      ...
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to Warl0cks Devs!</h1>
          <div className={styles.description}>Welcome to the DAO!</div>
          <div className={styles.description}>
            Your Warl0cksCryptoDevs NFT Balance: {nftBalance}
            <br />
        ...
        <div>
          <img className={styles.image} src="frontend/public/cryptodevs/0.svg" />
        </div>
      </div>
